const ingresos = [
    ...
    new Ingresos("Venta Auto", 1500.00),
    new Ingresos("Ventas libros", 1200)

];

const egresos = [
    new Egreso("Alquiler Dpto", 900),
    new Egreso("Ropa", 1000),
    new Egreso("Compra Super", 800)
];
...
function agregarDato(){
    ...
    if(descripcion.value !== "" && valor.value !== ""){
        if(tipo.value === "ingreso"){
            ingresos.push(new Ingresos(descripcion.value, Number(valor.value)));
            cargarCabecero();
            cargarIngresos();
        }
